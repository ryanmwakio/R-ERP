...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Slots Taken</p>
			<h3 class="text-white mb-0 font-weight-500">Kshs 98,250 <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Slots Lost</p>
			<h3 class="text-white mb-0 font-weight-500">Kshs 25,250 <small class="text-danger"><i class="fa fa-caret-down"></i> -0.5%</small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box">
	<div class="box-header">
		<h4 class="box-title align-items-start flex-column">
			New Staff Members
			<small class="subtitle">More than 30+ new members </small>
		</h4>
	</div>
	<div class="box-body">
			...
			<table class="table no-border">
				<thead>
					<tr class="text-uppercase bg-lightest">
						<th style="min-width: 250px"><span class="text-white">members</span></th>
						<th style="min-width: 100px"><span class="text-fade">paid</span></th>
	 ...
	 <div class="bg-img h-50 w-50" style="background-image: url(../images/gallery/creative/img-1.jpg)"></div>
								...
								<div>
									<a href="#" class="text-white font-weight-600 hover-primary mb-1 font-size-16">Didmus Zekaya</a>
									<span class="text-fade d-block"> Staff, Nairobi</span>
								</div>
							</div>
						</td>
						<td>
					...
					<tr>										
						<td class="pl-0 py-8">
							<div class="d-flex align-items-center">
								...
								<div>
									<a href="#" class="text-white font-weight-600 hover-primary mb-1 font-size-16">Victoria Amani</a>
									<span class="text-fade d-block"> Staff, Nairobi</span>
								</div>
							</div>
						</td>
					...
					<tr>										
						<td class="pl-0 py-8">
							<div class="d-flex align-items-center">
								...
								<div>
									<a href="#" class="text-white font-weight-600 hover-primary mb-1 font-size-16">Francis Okal</a>
									<span class="text-fade d-block"> Staff, Nairobi</span>
								</div>
							</div>
						</td>
					...
					<tr>										
						<td class="pl-0 py-8">
							<div class="d-flex align-items-center">
								...
								<div>
									<a href="#" class="text-white font-weight-600 hover-primary mb-1 font-size-16">Orwa Timon</a>
									<span class="text-fade d-block"> Staff, Nairobi</span>
								</div>
							</div>
						</td>
					...
					<tr>										
						<td class="pl-0 py-8">
							<div class="d-flex align-items-center">
								...
								<div>
									<a href="#" class="text-white font-weight-600 hover-primary mb-1 font-size-16">Ashley Fauza</a>
									<span class="text-fade d-block"> Staff, Nairobi</span>
								</div>
							</div>
						</td>
